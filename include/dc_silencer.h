...
private:
	double rad_dt = 0.0f; // The delta radians added every sample
	double rad_pos = 0.0f; // The current position along our waves (in radians)
	double vol_dt = 0.0f;  // The delta volume decremented every sample
	double vol_pos = 0.0f; // The current volume level (as a fraction of 1)
};
